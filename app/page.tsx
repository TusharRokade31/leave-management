...
import { useEmployeeWorkStatus } from "@/hooks/useEmployeeWorkStatus"; // New import
...
const { employees, loading: workStatusLoading } = useEmployeeWorkStatus(currentUser, currentMonth); // New hook
    ...
    {!leaveHooks.loading && currentUser.role === "MANAGER" && (
      <div className="space-y-12">
        <div className="space-y-8">
          ...
          {/* NEW: Employee Work Status Table */}
          <div ref={taskMonitorRef} className="bg-white dark:bg-slate-900 rounded-[2rem] p-8 border border-gray-100 dark:border-slate-800 shadow-sm space-y-6 transition-colors">
